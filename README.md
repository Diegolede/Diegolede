...
- **Aplicaciones:** Automatización de procesos, formateo y gestión de datos

### Diseño UX/UI
- **Herramientas:** Figma, Adobe Suite, Affinity Studio
- **Especialización:** Diseño de interfaces centradas en el usuario
